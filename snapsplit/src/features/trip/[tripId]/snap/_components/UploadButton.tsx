    ...
    <div className="flex flex-col items-center gap-2 mt-auto mb-18 ml-auto mr-5 pointer-events-auto ">
      {isScrolled && (
        <button
          ...
          className="flex items-center cursor-pointer justify-center gap-0.5 px-2 bg-primary min-w-11 h-11 rounded-full shadow-[0px_0px_2px_0px_rgba(34,34,34,0.25)]"
        >
