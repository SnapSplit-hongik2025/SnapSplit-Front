      ...
      <div className="flex items-center justify-between gap-2 w-full mb-auto px-5 py-4">
        <div className="flex flex-col gap-3">
          ...
          >
            ...
            <Image src="/svg/arrow-bottom.svg" alt="arrowBottom" width={24} height={24} />
          </button>
        </div>
        <button
          onClick={onFilterOpen}
          className="self-start cursor-pointer flex-shrink-0 flex items-center w-8 h-8 p-1 bg-white rounded-full border-1 border-grey-250"
        >
